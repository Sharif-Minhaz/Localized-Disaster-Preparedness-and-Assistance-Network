...
export default function UserStatus() {
	...
	return (
		<div className="flex items-center gap-4 px-3 py-2 shadow-sm w-full rounded-xl border drop-shadow-md dark:bg-slate-900 bg-[#f7f7f7] dark:bg-opacity-40 backdrop-blur">
