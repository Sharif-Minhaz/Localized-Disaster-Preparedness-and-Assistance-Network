...
export default function ThreatCard({ data, index }: Props) {
	return (
		<motion.article
			...
			className="p-2 shadow-sm hover:shadow transition-all w-full rounded-xl border relative drop-shadow-lg dark:bg-slate-900 bg-white dark:bg-opacity-40 bg-opacity-50 backdrop-blur"
		>
