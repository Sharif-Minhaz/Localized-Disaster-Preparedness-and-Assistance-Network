...
export default function Sidebar() {
	...
	return (
		<aside className="fixed left-0 top-0 z-20 flex h-screen w-[255px] flex-col justify-between overflow-auto border-r border-r-dark-4 bg-dark-2 pb-5 max-md:hidden">
